...
#define wifi_ssid "INPT-Test"
#define wifi_password "iinnpptt"
#define mqtt_server "10.1.6.22"
...
void loop() {
      ...
      // Ajouter un nombre à la valeur de température
      const float ajustementTemperature = 5.0;  // Ajoutez ou soustrayez ce nombre selon vos besoins
      t += ajustementTemperature;

      // Assurez-vous que la valeur ajustée reste dans la plage souhaitée
      if (t < 35.0) {
        t = 35.0;
      } else if (t > 40.0) {
        t = 40.0;
